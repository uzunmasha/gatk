...
include { CREATE_GENOME_INDEX } from '../../modules/create_genome_index/main.nf'
include { CREATE_FASTA_INDEX  } from '../../modules/create_fasta_index/main.nf'
include { CREATE_SEQ_DICT     } from '../../modules/create_seq_dict/main.nf'
include { ALIGN_READS         } from '../../modules/align_reads/main.nf'
include { ADD_READ_GROUPS     } from '../../modules/add_read_groups/main.nf'
